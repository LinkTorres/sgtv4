						...
						<h2><i class="fa fa-user-plus"></i><strong> Agregar Profesores</strong> Form</h2>
								...
								<div id="basic-form" class="collapse in">
									...
									<div class="form-group">
										<div class="row">
										<label class="col-md-12" for="form-field-1"> Cédula </label>
									...
									<div class="form-group">
										...
										<div class="col-md-4">
										{{ Form::select('cargo', array('Profesor' => 'Profesor', 'Director' => 'Director', 'Subdirector'=> 'Subdirector','Otro' => 'Otro' ),null, array('class' => 'form-control')); }}
										</div>														
									</div>
				...
				<div class="md-content">
					...
					<div>
						...
						{{ Form::open(array('url' => '/actualizarProfesores')); }}
															...
															<div class="form-group">
																<div class="row">
																<label class="col-md-12" for="form-field-8">Género</label>
																<span class="input-icon col-md-2">
															...
															<div class="form-group">
																...
																<label class="col-md-12" for="form-field-1"> E-mail </label>
